...
const Page4 = () => {
  return (
    <div className=" flex flex-col bg-slate-200 h-screen  font-sans">
      ...
      <div className='flex p-20 h-60 overflow-x-auto overflow-hidden'>
    


    <div className=' flex'>
      
    <div className='  mt-20 ml-6 h-[450px] w-[300px]'>
    ...
    <div className='  mt-20 ml-6 h-[450px] w-[300px]  rounded-2xl'>
