...
const Page2 = () => {
  ...
  <div className='p-20'>
  <button className=' bg-white  text-black text-2xl font-bold cursor-pointer font-sans rounded-2xl py-2 px-10  hover:bg-slate-400 border-black hover:animate-pulse'>SET THE WORK
